...
export function ClockSection({ timeString, timeZone, locationName, isExpanded, onToggle } : ClockSectionProps) {
    return (
        ...
        <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className="text-sm mb-14 font-bold tracking-[3px] md:text-2xl md:mb-20 lg:mb-0">{locationName || "Carregando localização..."}</p>
          </div>
        </div>
