...
export function ExpandedInfo({ locationName, dayOfWeek, dayOfYear, weekNumber }: ExpandedInfoProps) {
  return (
    <ul className="bg-white/75 px-4 py-10 flex flex-col items-start w-full gap-6 md:grid md:grid-cols-2 md:gap-x-80 md:gap-y-10 md:py-20 md:px-16 lg:px-40 lg:py-15 ">
